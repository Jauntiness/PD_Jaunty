...
def create_only_watched_not_unwatched_all_users(plex_library):
    ...
    for user in plex_library.users:
        ...
        watched_movies_with_year = [clean_name_with_year(name) for name in watched_movies_with_year]
        unwatched_movies_with_year = [clean_name_with_year(name) for name in unwatched_movies_with_year]
        ...
        watchedlist.update(watched_movies + watched_movies_years + watched_shows + watched_shows_seasons)
        unwatchedlist.update(unwatched_movies + unwatched_movies_years + unwatched_shows + unwatched_shows_seasons)
    ...
    only_watched_not_unwatched_all_users = list(only_watched_not_unwatched_all_users)
    ...
    only_watched_not_unwatched_all_users.sort()
